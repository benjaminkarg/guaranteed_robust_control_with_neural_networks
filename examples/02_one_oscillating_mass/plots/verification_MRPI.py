...
""" Load algo data """
# Guess
data_guess = sio.loadmat(f'./../data/verification_MRPI.mat')
...
P = plt.Polygon(V, edgecolor = 'C1', fill = False, linewidth = 3.0, label = r'$\tilde{\mathcal{R}}_3(\mathcal{X}_{\text{s}})$', alpha = 1.0, linestyle = '-')
ax.add_patch(P)
...
ax.autoscale_view()
fig.tight_layout()
plt.savefig(f"verification_MRPI.pdf", format = 'pdf')
