...
%% Params
u_ub =  5.0; % lower bound of control input
u_lb = -5.0; % upper bound of control input
n_hp = [10, 20, 30]; % number of hyperplanes
r_seqs = {[1, 1, 1, 1, 1, 1], [2, 2, 2], [3, 3], [6]}; % r sequences
